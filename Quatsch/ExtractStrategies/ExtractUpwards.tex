...
\draw[help lines] (grasp)--++(0,0,3)coordinate[pos=.9](retract) coordinate[pos=.34](start);
...
\draw[|<->|, help lines] ($(grasp)+(0,-.2)$)--($(retract)+(0,-.2)$) node[midway, above, sloped] {extract distance};
