...
% DUT
\path[filldut_top] (K)++(0,0,\hz)arc(270:270+\betI:\rbI)--++(-90+\betI:\by)arc(270+\betI:270:\rbIe)--++(0,\by);

\path (K)++(0,-\by)coordinate(LL)++(0,0,\hz)coordinate(LU); % Init LastLower & LastUpper
\foreach \dp in {.05,.1,..., 1.01}{
	\path (K)++(0,-\by)arc(270:270+\betI:\rbIe)coordinate[pos=\dp](L);
	\path[filldut_side] (LU)--(LL)--(L)--++(0,0,\hz)--cycle;
	\path (L)coordinate(LL) ++ (0,0,\hz)coordinate(LU);
}
