...
flussigg/.style={fill=red!50, opacity=1},	% flüssiges Elastosil
...
\path[flussigg] (-\hx-\thick-\hxa,-\yges-\bdy-\thick-\thick-\thick) rectangle ++(\Xges,\fhy)coordinate[midway](Flussig);
...
\path[elastosil] (BOL)++(0,-\bdy)coordinate(BOL)--++(\Xges,0)--++(0,-\bhy)coordinate(BUR)--++(-\Xges,0)--cycle;
